...
Nine questions are open, and the next one taken is whether items are written before or after the decomposition gate. The rest are not listed here: the row above says which records still need a writer and readers, and a list of them kept beside it is a second place to edit every time one is answered.
