...
**Verify against intent** — at a [gate](how-humans-do-it/03-gates.md#where-a-gate-is-and-what-decides-it), so as often as the [score](how-humans-do-it/04-risk-score.md) or a pin (9) says:

6. Confirm the [acceptance criteria](how-humans-do-it/03-gates.md#spec) are the right ones. Unit tests are today's encoding of them; what a human is checking is the criteria, not the test code.
7. Perform UAT.
