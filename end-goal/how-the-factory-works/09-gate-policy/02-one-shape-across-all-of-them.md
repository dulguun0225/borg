...
The window limit and the analysis window's parameters are per service and are fields of the
[_service record_](../02-intent-into-items/03-decomposition/README.md); the item-size target
