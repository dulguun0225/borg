...
[platform](../05-environments/02-an-environment-per-candidate.md), and the notifier's
one. So no component needs a threshold authored per instance to be told apart from a silent
