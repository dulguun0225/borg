...
|---|---|
| [Where a gate is, and what decides it](01-where-a-gate-is-and-what-decides-it.md) | The two kinds of gate, and what a firing writes into [the log](../../deferred.md) |
| [The rollout strategy](02-the-rollout-strategy.md) | How a [release](../06-releases/02-the-release-record.md) takes live traffic from the [build](../05-environments/01-records-and-one-long-lived-branch.md) it replaces |
| [Actions at each gate](03-actions-at-each-gate.md) | The actions available at each gate, and why each is there |
