...
//
// held_out is copied onto the row for the reason passed_available is not enough on
...
// because it has nothing to compare against. Both have passed_available false and
