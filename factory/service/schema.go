...
//
// The name is unique in the store, so two decompositions creating one service name is a
...
// supply. They are the second writer's columns and decomposition never writes them,
