...
```sh
go run ./cmd/factory run -secrets <file> [-provider <name>] -model <name> -repo <dir> -service <name> -area <name> -targets <dir> -intent <statement>
