...
// writer are ../../end-goal/how-humans-do-it/07-contracts.md#two-versioned-things;
// the promise each kind makes is
// ../../end-goal/how-humans-do-it/07-contracts.md#what-a-contract-promises and,
// for a store, ../../end-goal/how-humans-do-it/07-contracts.md#the-store-is-a-contract-too;
// the diff and what a breaking one is are
// ../../end-goal/how-humans-do-it/07-contracts.md#enforcement; the deprecation
// mark being derived from the build and minting a minor is
// ../../end-goal/how-humans-do-it/07-contracts.md#deprecation; and the unit
// belonging to an element's name is
// ../../end-goal/how-humans-do-it/07-contracts.md#what-a-diff-cannot-see.
package contract
