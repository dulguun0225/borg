...
// postgres". db_test.go is the holding table and the re-derivation,
// mapping_test.go is the key-to-name mapping and its deletion, and
// fixtures_test.go holds their shared setup. Each file stays below 500 lines.
//
