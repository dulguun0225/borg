...
//
// What defines it:
// ../../end-goal/how-the-factory-works/09-gate-policy/01-what-is-in-it.md for the rows
// and ../../end-goal/how-the-factory-works/09-gate-policy/02-one-shape-across-all-of-them.md
