...
The sections run in dependency order — each leans on the ones before it. The numeric prefix on each filename carries that order; prose refers to a section by name.
...
| [Environments](04-environments.md) | Where software runs, and the branches that feed it |
