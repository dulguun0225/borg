...
- **People** — humans, roles, who gates what, who does UAT, who lent a credential [_the fleet_](10-fleet.md) runs on, and which holder of a duty a [_page_](08-operations.md#pages) reaches now. Declared, not enforced: the model routes work today, and is the seam authentication attaches to later.
